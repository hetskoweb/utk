...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\n\r\n\r\nconst swiper = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\r\n\r\nconst menuToggle = document.querySelector('.menu__toggle-icon');\r\nconst menu = document.querySelector(\".menu-toggle\");\r\n\r\nmenuToggle.addEventListener(\"click\", function () {\r\n    menu.classList.toggle(\"active\");\r\n});\r\n\r\nwindow.addEventListener('DOMContentLoaded', function () {\r\n    var isMobile = window.matchMedia(\"(max-width: 991px)\").matches;\r\n\r\n    if (isMobile) {\r\n        menuToggle.addEventListener('click', function () {\r\n            if (document.body.classList.contains('no-scroll')) {\r\n                // Разрешить прокрутку страницы\r\n                document.body.classList.remove('no-scroll');\r\n            } else {\r\n                // Дополнительные действия, связанные с открытием меню\r\n\r\n                // Запретить прокрутку страницы\r\n                document.body.classList.add('no-scroll');\r\n            }\r\n        });\r\n    } else {\r\n        // Дополнительные действия на больших экранах\r\n    }\r\n});\r\n\r\nlet divisionItems = document.querySelectorAll(\".projects__tab-item\");\r\nlet divisionTitles = document.querySelectorAll(\".projects__tab\");\r\n\r\nfunction setTabActive() {\r\n    for (let item of divisionTitles) {\r\n        item.classList.remove('active');\r\n    }\r\n    this.classList.add(\"active\");\r\n\r\n    const array1 = Array.from(divisionTitles);\r\n    const n = array1.indexOf(this);\r\n\r\n    for (let item of divisionItems) {\r\n        item.classList.remove(\"active\");\r\n    }\r\n    divisionItems[n].classList.add(\"active\");\r\n}\r\n\r\nfor (let item of divisionTitles) {\r\n    item.onclick = setTabActive;\r\n}\r\n\r\nlet divisionTitles2 = document.querySelectorAll(\".fridge-equipment__tab\");\r\nlet divisionItems2 = document.querySelectorAll(\".fridge_equipment__item\");\r\n\r\ndocument.addEventListener(\"DOMContentLoaded\", function () {\r\n    var form = document.querySelector(\".form__form\");\r\n    form.addEventListener(\"submit\", function (event) {\r\n        var nameInput = form.querySelector(\".form__form-input[name='name']\");\r\n        var phoneInput = form.querySelector(\".form__form-input[name='phone']\");\r\n        var emailInput = form.querySelector(\".form__form-input[name='email']\");\r\n        var checkbox = form.querySelector(\".form__form-checkbox\");\r\n        var errorText = form.querySelector(\".error-text\");\r\n\r\n        var hasError = false;\r\n\r\n        if (!isValidName(nameInput.value)) {\r\n            nameInput.classList.add(\"error\");\r\n            hasError = true;\r\n        } else {\r\n            nameInput.classList.remove(\"error\");\r\n        }\r\n\r\n        if (!isValidPhone(phoneInput.value)) {\r\n            phoneInput.classList.add(\"error\");\r\n            hasError = true;\r\n        } else {\r\n            phoneInput.classList.remove(\"error\");\r\n        }\r\n\r\n        if (!isValidEmail(emailInput.value)) {\r\n            emailInput.classList.add(\"error\");\r\n            hasError = true;\r\n        } else {\r\n            emailInput.classList.remove(\"error\");\r\n        }\r\n\r\n        if (!checkbox.checked) {\r\n            checkbox.classList.add(\"error\");\r\n            hasError = true;\r\n        } else {\r\n            checkbox.classList.remove(\"error\");\r\n        }\r\n\r\n        if (hasError) {\r\n            event.preventDefault();\r\n            errorText.innerText = \"Будь ласка, заповніть всі обов'язкові поля.\";\r\n        } else {\r\n            errorText.innerText = \"\";\r\n        }\r\n    });\r\n\r\n    let checkbox = form.querySelector(\".form__form-checkbox\")\r\n    checkbox.addEventListener(\"change\", function () {\r\n        if (this.checked) {\r\n            this.classList.remove(\"error\");\r\n        }\r\n        else {\r\n            console.log(this);\r\n            this.classList.add(\"error\");\r\n        }\r\n    });\r\n\r\n    function isValidName(name) {\r\n        return name.trim() !== \"\";\r\n    }\r\n\r\n    function isValidPhone(phone) {\r\n        return /^\\+380\\d{9}$/.test(phone);\r\n    }\r\n\r\n    function isValidEmail(email) {\r\n        return /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/.test(email);\r\n    }\r\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
